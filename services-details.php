...
$Services= array(
    array(
        "name" => "Dental Implant",
        "about" => "A dental implant is a surgical component that interfaces with the bone of the jaw or skull to support a dental prosthesis such as a crown, bridge, denture, facial prosthesis or to act as an orthodontic anchor.",
...
"img" => "SmileIsPriceless.jpeg"
    ...
    array(
        "name" => "And Many More",
        "about" => "click here To See All Services That We Provide"
    )
